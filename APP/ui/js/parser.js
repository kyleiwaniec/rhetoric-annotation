...
function parse(textData, article_id, sentence_id, annotation_id, annotator_id, techniques) {
	// Reset
	pos = 0;
	currentNode = null;
	root = null;
	...
	// add metadata to the JSON (root.toJSON()) string
	var rootJSONstring = root.toJSON();



	var meta_data = '"article_id": \"'+article_id+
	...
	rootJSONstring = [rootJSONstring.slice(0, 1), meta_data, rootJSONstring.slice(1)].join('');
