...
class GPT:
    def __init__(self, model):
        ...
        with open('../APP/features-sentence-v2.json') as f:
            for jsonObj in f:
        ...
        with open('../APP/features-word-v2.json') as f:
            for jsonObj in f:
                featureDict = json.loads(jsonObj)
    ...
    def get_gpt_response(self,sentence,feature,sid,temp):
        ...
        Format your response as a JSON object with "Properties" and "Explanation" as the keys. The value of "Properties" should be a list. Choose only from the properties provided, and list the relevant properties exactly as they appear without any modification. You may select {multiplicity}. If none of the properties are present, return an empty list. Explain your choice in the "Explanation". Make your response as short as possible.
        """
